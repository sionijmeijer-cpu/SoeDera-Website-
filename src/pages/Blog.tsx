...
function BlogContent() {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // ARTICLE LIST
  // Every `id` must match a key in blogArticles inside BlogDetail.tsx
  // Every `author` must match a key in authors inside BlogDetail.tsx
  // ─────────────────────────────────────────────────────────────────────────
  const blogPosts = [
    {
      id: 'sam-introduction',
      ...
      excerpt:
        'We are building SAM — SøDera Asset Management — a cloud-native platform that brings IEC 81346 compliance, real-time collaboration, and enterprise integration to Reference Designation System management.',
      date: '2024-12-31',
    ...
    },
    {
      ...
      excerpt:
        'Building Information Modelling has reshaped how the energy and construction sectors design, build, and operate assets. Here is what the next wave looks like — and what it means for your documentation strategy.',
      date: '2025-01-05',
    ...
    },
    {
      ...
      excerpt:
        'Choosing the wrong methodology for your project type is one of the most common and costly mistakes in technical project management. Here is a practical framework for deciding.',
      date: '2025-01-12',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      {/* Hero Banner */}
      <section
        className="relative w-full h-60 sm:h-80 md:h-96 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: 'url(https://i.imgur.com/8ocvstf.png)',
          backgroundSize: '80%',
        }}
      />
      ...
      <section className="bg-blue-900 py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-xl md:text-2xl text-white mb-6 sm:mb-8 opacity-95 leading-relaxed px-4">
            Subscribe to our newsletter for the latest insights on information management,
          ...
          >
            ...
            <Button
              type="submit"
              className="w-full sm:w-auto bg-white text-orange-600 hover:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 rounded-lg shadow-lg hover:shadow-2xl font-bold text-sm sm:text-base transform hover:scale-105 transition-all duration-200"
            >
              Subscribe
            </Button>
          </form>
